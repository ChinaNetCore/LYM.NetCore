...
(function (root, factory) {
    ...
    var DateRangePicker = function (element, options, cb) {
                ...
                '<div class="ranges">' +
                    '<div class="range_inputs">' +
                        '<button class="applyBtn" disabled="disabled" type="button"></button> ' +
                           '<button class="clearBtn"  type="button">Çå¿Õ</button> ' +
        ...
        this.container.addClass('opens' + (this.opens == 'right' ? 'left' : 'right'));
    ...
    DateRangePicker.prototype = {
        ...
        move: function () {
            ...
            if (this.opens == 'left') {
                ...
                console.log(this.element.offset().left, parentOffset.left, this.container.outerWidth(), this.container.offset().left + this.container.outerWidth(), $(window).width())
