$(function() {
    ...
    function c() {
        ...
        if (k) {
            var p = '<a href="javascript:;" class="active J_menuTab" data-id="' + o + '">' + l + ' <i class="fa fa-times"></i></a>';
...
function addTabs(href, title) {
    var o = href || "",
        m = Math.floor(Math.random() * 5000 + 10000);
        l = $.trim(title || "");
        k = true
        if (o == "" || $.trim(o).length == 0) { return false };
        $(".J_menuTab").each(function () {
            if ($(this).data("id") == o) {
                if (!$(this).hasClass("active")) {
                    $(this).addClass("active").siblings(".J_menuTab").removeClass("active");
